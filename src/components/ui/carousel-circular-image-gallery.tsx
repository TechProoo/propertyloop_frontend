...
export const ImageGallery = forwardRef<ImageGalleryHandle, ImageGalleryProps>(function ImageGallery(
  {
  ...
  useEffect(() => {
    const w = window as Window & { gsap?: GsapInstance; MotionPathPlugin?: unknown }
    ...
    gsapScript.onload = () => {
      ...
      motionPathScript.onload = () => {
        const w2 = window as Window & { gsap?: GsapInstance; MotionPathPlugin?: unknown }
  ...
  return (
    <div className={`relative ${className}`}>
      {/* Gallery container */}
      <div className="relative w-full h-full overflow-hidden rounded-[20px] shadow-[0_12px_40px_rgba(0,0,0,0.15)]">
        {gsapReady &&
          images.map((image, i) => (
            <div
              key={image.url}
