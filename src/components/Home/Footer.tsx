...
// Brand glyphs — installed lucide-react is too old to ship social icons,
// so inline the SVGs. All use currentColor to inherit text colour on hover.
            ...
            <div className="lg:w-70 shrink-0">
              ...
              <div className="flex gap-3 mt-6">
                {[
                  ...
                  {
                    label: "Facebook",
                    href: "https://facebook.com/propertyloop",
                    Icon: FacebookIcon,
                  },
                ].map(({ label, href, Icon }) => (
                  <a
                    ...
                    aria-label={label}
                    title={label}
                    className="w-9 h-9 rounded-full bg-white/80 backdrop-blur-sm border border-border-light flex items-center justify-center text-text-subtle hover:bg-primary hover:text-white hover:border-primary transition-all duration-300"
                  >
