                ...
                <div className="flex gap-3">
                  {[
                    ...
                    <a
                      ...
                      className="w-10 h-10 rounded-full bg-white/80 border border-border-light flex items-center justify-center text-text-secondary text-xs font-medium hover:bg-primary hover:text-white hover:border-primary transition-all"
                    >
                      {s.label}
                    </a>
                  ))}
