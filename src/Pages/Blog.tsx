        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.06)] mb-10">
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://images.unsplash.com/photo-1504711434969-e33886168d5c?w=1400&h=600&fit=crop)",
              }}
            />
            ...
            <div className="relative z-10 p-8 sm:p-10 lg:p-14">
              ...
              <p className="text-white/60 text-sm leading-relaxed mt-3 max-w-xl">
                Market insights, property guides, product updates, and expert
                tips from Nigeria's next-generation real estate platform.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            {categories.map((c) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium border transition-all inline-flex items-center gap-1.5 ${activeCat === c ? "bg-primary text-white border-primary" : "bg-white/80 text-primary-dark border-border-light hover:border-primary hover:text-primary"}`}
              >
                {c === "All" ? (
            ...
            {filtered.map((post, i) => (
              ...
              >
                ...
                <div className="mx-3 mb-3 -mt-6 relative z-10 bg-white/70 backdrop-blur-md border border-white/40 rounded-2xl px-5 pt-4 pb-5 shadow-[0_4px_16px_rgba(0,0,0,0.06)]">
                  <h3 className="font-heading font-bold text-primary-dark text-[15px] leading-snug line-clamp-2">
                    {post.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-1 text-text-subtle text-xs">
